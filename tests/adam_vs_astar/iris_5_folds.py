#==============================================================================================================================================================
#==============================================================================================================================================================
#--------------------------------------------------- python -m tests.adam_vs_astar.iris_5_folds ---------------------------------------------------------------
#==============================================================================================================================================================
#==============================================================================================================================================================
...
for fold, (train_idx, test_idx) in enumerate(cv_folds):
    ...
    metrics_list[0]["evaluation_scores"].append(evaluate_pathnet_classification(trainer, (X_test_fold, Y_test_fold)))
...
for fold, (train_idx, test_idx) in enumerate(cv_folds):
    ...
    metrics_list[1]["evaluation_scores"].append(evaluate_pathnet_classification(trainer, (X_test_fold, Y_test_fold)))
...
for fold, (train_idx, test_idx) in enumerate(cv_folds):
    ...
    metrics_list[2]["evaluation_scores"].append(evaluate_pathnet_classification(trainer, (X_test_fold, Y_test_fold)))
...
for fold, (train_idx, test_idx) in enumerate(cv_folds):
    ...
    metrics_list[3]["evaluation_scores"].append(evaluate_sgd_classification(iris_model, test_dataloader_fold))
