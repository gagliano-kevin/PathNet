...
\begin{itemize}
    ...
    \item \textbf{Optimality:} Only guaranteed if the graph is a tree (no repeated states), or if the memory consumption of the Closed Set is an absolute bottleneck.
\end{itemize}
