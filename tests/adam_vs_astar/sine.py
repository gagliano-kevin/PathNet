...
for run in range(RUNS):
    ...
    plot_sine_predictions(test_x_np=X_test.numpy(), 
                        ...
                        directory=TEST_NAME,
                        filename=f"SK_astar_sine_predictions_run_{run + 1}.png")
...
for run in range(RUNS):
    ...
    plot_sine_predictions(test_x_np=X_test.numpy(), 
                    ...
                    true_sin_np=Y_test.numpy(),
                    directory=TEST_NAME,
                    filename=f"LWK_astar_sine_predictions_run_{run + 1}.png")
...
for run in range(RUNS):
    ...
    plot_sine_predictions(test_x_np=X_test.numpy(), 
                    ...
                    true_sin_np=Y_test.numpy(),
                    directory=TEST_NAME,
                    filename=f"RS_astar_sine_predictions_run_{run + 1}.png")
...
for run in range(RUNS):
    ...
    metrics_list[3]["evaluation_scores"].append(evaluate_sgd_regression(sine_model, test_dataloader))
