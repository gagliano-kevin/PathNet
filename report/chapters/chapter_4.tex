...
\section{Synthetic Dataset: Sine Function Regression}
...
\hline
\textbf{10} & \textbf{0.1705} & \textbf{0.1049} & 0.1261 & 0.0570 & 0.4328 & \textbf{367.11} \\
...
\textbf{[-10, 10]} & \textbf{0.1672} & \textbf{0.1456} & 0.1003 & 0.0618 & 0.3893 & 312.69 \\
...
\noindent This observation suggests that the search typically converges to a stable local minimum or a satisfactory solution within the first $1,000$ iterations. Rather than facilitating the discovery of deeper minima, the extended budget allows the algorithm to persist in high-dimensional plateaus or oscillate in local regions without meaningful improvement.
\begin{center}
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    ...
    \includegraphics[width=1.2\textwidth]{figures/sine_grid_search/sine_test_kernel_stride_avg_loss.png}
     \caption{Evolution of mean loss across iterations for varying kernel geometries}
\end{figure}
\end{center}
...
\begin{table}[htbp]
\centering
\caption{Impact of Kernel Sizes and Strides on Sine Regression Performance (10 Repetitions)}
...
(2, 2) & (3) & 2 & \textbf{0.0975} & 0.0673 & 0.0848 & 0.0217 & 0.3199 & 478.15 \\
