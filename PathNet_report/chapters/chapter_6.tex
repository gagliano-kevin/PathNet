...
For both regression and classification, the reporting of \textbf{Standard Deviation} is critical to our analysis. It serves as a proxy for the \textit{reliability} of the A* search under different neighbors generation strategies and optimization techniques . A low standard deviation across runs indicates that the search logic is consistently finding similar basins of attraction in the weight space, regardless of the random initialization.
