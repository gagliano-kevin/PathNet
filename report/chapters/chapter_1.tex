...
\begin{itemize}
    ...
    \item \textbf{Optimality:} A* is guaranteed to find the lowest-cost path if the heuristic function $h(n)$ is admissible. This makes it a preferred method for problems where minimizing the cost (or, in the context of this project, minimizing the training error) is paramount.
\end{itemize}
