...
\begin{itemize}
    \item \textbf{Optimal Search Configuration:} Preliminary studies in Chapter \ref{chap:hyperparameters_tuning} demonstrated that a vanilla $A^*$ approach is insufficient for deep architectures. The introduction of \textbf{Beam Search} proved essential to mitigate the curse of dimensionality, providing a balance between computational feasibility and convergence depth.
