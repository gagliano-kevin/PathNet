...
def plot_mean_loss_with_std(astar_mean, astar_std, grad_mean, grad_std, runs, filename="circle_mean_loss_comparison_with_std.png"):
...
def plot_final_loss_distribution(astar_final_losses, grad_final_losses, runs, filename="circle_final_loss_boxplot.png"):
