...
plot_individual_algorithms(metrics, prefix=TEST_NAME, directory=TEST_NAME)
plot_all_algorithms(metrics, output_filename=TEST_NAME + "_comparison", directory=TEST_NAME)