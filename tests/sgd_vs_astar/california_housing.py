...
for run in range(RUNS):
    ...
    metrics_list[3]["evaluation_scores"].append(evaluate_sgd_regression(housing_model, test_dataloader))
...
TEST_NAME = "medium_net_california_housing_SGD_vs_A-star"
...
TEST_NAME = "big_net_california_housing_SGD_vs_A-star"
